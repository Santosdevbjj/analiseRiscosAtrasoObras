...
DB_PATH = os.path.join(
    BASE_DIR, "data", "processed", "df_mestre_consolidado.csv.gz"
)

# ======================================================
# FUNÇÃO DE VALIDAÇÃO DE ARQUIVOS
# ======================================================
def validar_arquivo(path: str, nome: str):
...
try:
    ...
    validar_arquivo(DB_PATH, "Base de Dados")
...
if not TOKEN or not WEBHOOK_URL:
    raise RuntimeError("❌ TELEGRAM_TOKEN ou WEBHOOK_URL não definidos no Render.")
